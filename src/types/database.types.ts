...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      athlete_conditions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "athlete_conditions_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "athlete_conditions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      metodo_bien_formado: { Args: { datos: Json }; Returns: boolean }
      mi_rol: { Args: never; Returns: Database["public"]["Enums"]["user_role"] }
      mi_tenant: { Args: never; Returns: string }
      plan_bien_formado: { Args: { datos: Json }; Returns: boolean }
      ver_invitacion: {
        Args: { p_token: string }
        Returns: {
          correo: string
